...
def edit_profile(request):
    ...
    return render(
        request, "edit_profile.html", {"title": title, "form": form, "profile": profile}
    )
...
def upload(request):
    ...
    return render(
        request, "upload.html", {"title": title, "user": request.user, "form": form}
    )
...
def search_results(request):
    if "profile" in request.GET and request.GET["profile"]:
        ...
        return render(
            request, "search.html", {"message": message, "profiles": searched_profiles}
        )
